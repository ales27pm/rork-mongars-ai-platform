...
const SPM_FILELIST_GUARD = [
  ...
  "        phase.name == '[MLX] Ensure Cmlx.modulemap'",
  "      end",
  "      if existing.nil?",
  "        phase = target.new_shell_script_build_phase('[MLX] Ensure Cmlx.modulemap')",
  "        phase.shell_script = <<-'SCRIPT'",
  'modulemap_dir="${OBJROOT}/GeneratedModuleMaps-${PLATFORM_NAME}"',
  'modulemap_path="${modulemap_dir}/Cmlx.modulemap"',
